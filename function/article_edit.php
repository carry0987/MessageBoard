...
if(!empty($_GET['id']) && $row = $result->num_rows > 0) {
  while($row = $result->fetch_assoc()) {
          echo '
          <form action="./function/send_article_edit.php?id='.$_GET['id'].'" method="post">
            ...
            <tbody>
              ...
              <tr>
               ...
               <script src="./static/js/ckeditor/ckeditor.js"></script>
                    <textarea class="ckeditor" id="article-edit"
                    type="text" name="content" placeholder="Article" 
          ...
          <div class="submit_edit">
              <button type="submit" name="change_article">'.$lang_edit.'</button>
          </div>
          </form>
     ';
  }
