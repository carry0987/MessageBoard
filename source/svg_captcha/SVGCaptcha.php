...
<svg 
  ...
  <g>
    <path
       style="fill:none;stroke:{{text_color}};stroke-width:2px;stroke-linecap:round;stroke-linejoin:miter;stroke-opacity:1"
       d="{{pathdata}}"
       id="captcha" />
  </g>
</svg>
EOD;
     ...
     */
    public static function getInstance($numchars, $height, $width, $text_color, $difficulty = SVGCaptcha::MEDIUM) {
        if (!isset(self::$instance)) {
            self::$instance = new SVGCaptcha($numchars, $width, $height, $text_color, $difficulty);
        }
     ...
     */
    private function __construct($numchars, $width, $height, $text_color, $difficulty) {
        include 'point.php';
        include 'glyphs.php';
        ...
        // supplied difficulty.
        if ($this->difficulty == self::EASY || $this->difficulty == 'easy') {
        ...
        } elseif ($this->difficulty == self::MEDIUM || $this->difficulty == 'medium') {
            $this->dsettings['transformations']['apply'] = true;
            $this->dsettings['transformations']['rotate'] = true;
            ...
            $this->dsettings['change_degree']['p'] = 5;
            $this->dsettings['split_curve']['apply'] = true;
        } elseif ($this->difficulty == self::HARD || $this->difficulty == 'hard') {
            $this->dsettings['transformations']['apply'] = true;
            $this->dsettings['transformations']['rotate'] = true;
            $this->dsettings['transformations']['skew'] = true;
            $this->dsettings['transformations']['scale'] = true;
    ...
    private function _write_SVG($path_str) {
        ...
        $svg_output = str_replace("{{text_color}}", $this->text_color, $svg_output);
